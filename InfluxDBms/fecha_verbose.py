...
class BatchProcess:
    ...
    def __init__(self, args):
        self.args = args  # Recibe los argumentos de configuración

    def get_cnf(self):
        """
        Devuelve la ruta del archivo de configuración.
        """
        return self.args.path  # Obtiene el path desde args

    def run(self):
        """
        Ejecuta el proceso en batch.
        """
        from_time = self.args.from_time
        until_time = self.args.until
