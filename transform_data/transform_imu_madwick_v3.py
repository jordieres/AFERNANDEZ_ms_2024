...
def main():
    ...
    for file_path in args.file_paths:
        ...
        try:
            ...
            # Aplica el filtro de Kalman después de tener gps_pos
            ...
            # Plot EKF 2D results
            plot_results(
                time, acc_lp, threshold, np.hstack((pos_ekf_2d, pos[:, 2:3])), vel, gps_pos=gps_pos,
                output_dir=output_dir if args.output_mode in ("save", "both") else None,
